...
public class RegisterAllocator {
	...
	// if (b.leftChild != null && b.mark == 0) {
	// live.addAll(LRTraverse(b.leftChild, 1));
	// b.mark = b.mark < b.leftChild.mark ? b.mark : b.leftChild.mark;
	// }
	// if (b.rightChild != null && b.mark == 0) {
	// live.addAll(LRTraverse(b.rightChild, 2));
	// b.mark = b.mark < b.rightChild.mark ? b.mark : b.rightChild.mark;
	// }
	//
	...
	// }
	//
	// // if we already visited this node, then this time we MUST have come
	// // from the right
	...
	// }
	//
	// System.out.println("Prime after " + inst.id + ": "
	// + liveprime);
	// }
	// }
	//
	// // infinity == -1
	// System.out.println("Setting bprime" + bb.id + " mark = "
	// + bb.mark);
